...
>(
	(
		...
		return (
			<div
				ref={ref}
				className="tw-group tw-peer tw-hidden md:tw-block tw-text-sidebar-foreground"
				data-state={state}
...
>(({ className, showIcon = false, ...props }, ref) => {
	...
	return (
		<div
			...
			className={cn("tw-rounded-md tw-h-8 tw-flex tw-gap-2 tw-px-2 tw-items-center", className)}
			{...props}
		>
			{showIcon && (
